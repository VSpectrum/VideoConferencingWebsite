$(function() {
	var config = {
	    openSocket: function (config) {
	        var SIGNALING_SERVER = 'https://conference.veydh.com:8888/',
	    ...
	    onRemoteStream: function (media) {
	    	...
	    	vidcontainer.setAttribute('class', 'vidContainer col-md-3');
...
//---------------------------------Setting up Statistics logging for Remote Stream------------------------------------------------
	        ...
	        recID=recID+1;
//------------------------------------------------------------------------------------------------------------
			videosContainer.appendChild(vidcontainer);
	        video.play();
	    },
	...
	videosContainer.setAttribute('class', 'row');
